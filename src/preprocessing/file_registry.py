...
#
# ⚠ **기기와 장소가 엉켜 있다.** 세션 D2 로 프로젝터가 D 에도 생겨 **양쪽에 있는 기기가
#   충전기 하나에서 둘(충전기·프로젝터)로 늘었다.** 남은 엉킴은 포트·드라이기·에어컨·선풍기(E 만)와
#   미니PC·핫플·오븐(D 만)이다. 교차 녹화가 이것을 끊는 유일한 자료다 (설계 13.14~13.15).
